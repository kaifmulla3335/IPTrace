...
function MapView({ lat, lng, ip, city, country }) {
  return (
    <motion.section
      ...
      className="relative z-10 px-4 md:px-8 -mt-10 md:-mt-16"
    >
      {/* Label bar */}
      ...
      <div className="max-w-7xl mx-auto">
        <div
          className="
          w-full h-[50vh] sm:h-[55vh] md:h-[65vh]
        ...
        >
          ...
          <div className="absolute top-0 left-0 right-0 h-10 bg-gradient-to-b from-ink-950/30 to-transparent z-10 pointer-events-none rounded-t-3xl" />
            ...
            <Marker position={[lat, lng]} icon={customIcon}>
              <Popup>
                <div className="text-center py-1">
                  <p className="font-mono text-cyan-400 text-sm font-semibold">
                    {ip}
                  </p>
                  {city && (
